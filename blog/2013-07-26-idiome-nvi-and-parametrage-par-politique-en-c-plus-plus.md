...
Cette approche, très utilisée en **Java** notamment, propose un désavantage de taille. En procédant de la sorte, nous donnons deux responsabilités à la classe concrète ```MonService``` :
